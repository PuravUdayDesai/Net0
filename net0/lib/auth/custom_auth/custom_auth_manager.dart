...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    net0AuthUserSubject.add(
      Net0AuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<Net0AuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  Net0AuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = Net0AuthUser(
      loggedIn: true,
      uid: authUid,
    );
    net0AuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
