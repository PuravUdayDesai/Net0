...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF019267);
  late Color secondary = const Color(0xFFFFD365);
  late Color tertiary = const Color(0xFF00C897);
  late Color alternate = const Color(0xFFFDFFA9);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF576F72);
  late Color secondary = const Color(0xFFE4DCCF);
  late Color tertiary = const Color(0xFF7D9D9C);
  late Color alternate = const Color(0xFFF0EBE3);
