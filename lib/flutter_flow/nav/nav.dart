...
class AppStateNotifier extends ChangeNotifier {
  ...
  void update(Net0AuthUser newUser) {
    final shouldUpdate =
        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: 'TradePage',
              path: 'tradePage',
              builder: (context, params) => const TradePageWidget(),
            ),
            FFRoute(
              name: 'DevicePage',
              path: 'devicePage',
            ...
            FFRoute(
              name: 'ConfirmPage',
              path: 'confirmPage',
              builder: (context, params) => const ConfirmPageWidget(),
            ),
            FFRoute(
              name: 'RuleSettingPage',
              path: 'ruleSettingPage',
              builder: (context, params) => const RuleSettingPageWidget(),
            )
